...
<link rel="stylesheet" href="{{ asset('assets/vendor/trumbowyg/plugins/colors/ui/trumbowyg.colors.min.css') }}">
<script src="{{ asset('assets/vendor/trumbowyg/plugins/colors/trumbowyg.colors.min.js') }}"></script>
...
<script src="{{ asset('assets/vendor/trumbowyg/plugins/highlight/trumbowyg.highlight.min.js') }}"></script>

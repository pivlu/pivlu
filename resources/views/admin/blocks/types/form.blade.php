<div class="card p-3 bg-light mb-4">
    ...
    <div class="col-md-4 col-lg-3 col-xl-2">
        <div class="form-group">
            <label>{{ __('Submit button class') }}</label>
            <input type="text" class="form-control" name="submit_btn_class" value="{{ $block_settings['submit_btn_class'] ?? null }}">
            <div class="form-text">{{ __('Add a custom CSS class for submit button') }}</div>
        </div>
    </div>

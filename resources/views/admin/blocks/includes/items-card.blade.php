        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-7 col-md-6 order-md-2 order-last">
                <div class="float-end">
                    ...
                    @include('admin.blocks.includes.modal-create-card-item')
                </div>
            </div>
        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{ route('admin.block.delete-item', ['type' => 'card', 'block_id' => $block->id, 'code' => $content_item['code']]) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                    ...
                    <div class="modal fade update-{{ $content_item['code'] }}" tabindex="-1" role="dialog" aria-labelledby="ConfirmUpdateLabel-{{ $content_item['code'] }}" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form method="post" enctype="multipart/form-data" action="{{ route('admin.block.update-item', ['type' => 'card', 'block_id' => $block->id]) }}">
                                    @csrf
                                    @method('PUT')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="icon_{{ $item_lang->id }}" value="{{ $item_data->icon ?? null }}">
                                                    </div>
                                                </div>
                                            </div>

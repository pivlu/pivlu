    ...
    <div class="card-body">
        ...
        <form method="post">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="listing_title_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->listing_title_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->listing_title_size ?? null) && $font_size->value == '1.3em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="listing_text_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->listing_text_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->listing_text_size ?? null) && $font_size->value == '1em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="listing_meta_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->listing_meta_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->listing_meta_size ?? null) && $font_size->value == '0.9em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-2">
                        ...
                        <select class="form-select col-md-6 col-lg-4 col-xl-3" name="listing_link_underline_offset">
                            ...
                            <option @if (($templateConfig->listing_link_underline_offset ?? null) == '0.17em') selected @endif value="0.17em">{{ __('Small offset') }}</option>
                            <option @if (($templateConfig->listing_link_underline_offset ?? null) == '0.35em') selected @endif value="0.35em">{{ __('Medium offset') }}</option>
                            <option @if (($templateConfig->listing_link_underline_offset ?? null) == '0.6em') selected @endif value="0.6em">{{ __('Big offset') }}</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="post_title_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->post_title_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->post_title_size ?? null) && $font_size->value == '2em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="post_meta_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->post_meta_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->post_meta_size ?? null) && $font_size->value == '0.9em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="post_text_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->post_text_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->post_text_size ?? null) && $font_size->value == '1em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="categs_font_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->categs_font_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->categs_font_size ?? null) && $font_size->value == '1.2em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="text-muted small mb-3">
                ...
                <a href="{{ route('admin.template', ['module' => 'posts']) }}">{{ __('Go to posts template builder') }}</a>
            </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="custom_title_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->custom_title_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->custom_title_size ?? null) && $font_size->value == '1.3em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="custom_text_size">
                            @foreach ($font_sizes as $font_size)
                                <option @if (($templateConfig->custom_text_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->custom_text_size ?? null) && $font_size->value == '1em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

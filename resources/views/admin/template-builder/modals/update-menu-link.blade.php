                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="form-select" id="update_menu_link_{{ $link->id }}" onchange="showDiv_{{ $link->id }}()" required>
                                    ...
                                    <optgroup label="{{ __('Module') }}">
                                        <option @if ($link->type == 'posts') selected @endif value="posts">{{ __('Posts') }}</option>
                                        <option @if ($link->type == 'forum') selected @endif value="forum">{{ __('Community Forum') }}</option>
                                        <option @if ($link->type == 'docs') selected @endif value="docs">{{ __('Knowledge Base') }}</option>
                                        {{--<option @if ($link->type == 'glossary') selected @endif value="glossary">{{ __('Glossary') }}</option>--}}
                                    </optgroup>
                                </select>
                            </div>
                        </div>

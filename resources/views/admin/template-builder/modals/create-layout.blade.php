                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="layout_top" name="top">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="layout_bottom" name="bottom">
                        ...
                        <div id="hidden_div_sidebar" style="display: none">
                            ...
                            <div class="form-group">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="use_bg_color">{{ __('Add background color to this sidebar') }}</label>
                                </div>
                            </div>

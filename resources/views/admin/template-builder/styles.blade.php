...
<div class="card">
    ...
    <div class="card-body">
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'global']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'nav']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'nav_dropdown']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'footer']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'footer2']) }}">{{ __('Update style') }}</a>
                            </div>
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'posts']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'forum']) }}">{{ __('Update style') }}</a>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="float-end ms-2">
                                <a class="btn btn-primary btn-sm mb-2" href="{{ route('admin.template.styles.show', ['style' => 'docs']) }}">{{ __('Update style') }}</a>
                            </div>
        ...
        <div class="card-title fs-5 fw-bold mb-1 mt-4">{{ __('Custom styles') }}</div>
        <div class="text-muted small mb-3">

        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="border_color" name="border_color" value="{{ $button->border_color ?? config('nura.defaults.button_bg_color') }}">
                            <label>{{ __('Border color') }}</label>
                            <div class="mt-1 small"> {{ strtoupper($button->border_color) ?? config('nura.defaults.button_bg_color') }}</div>
                            <script>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="border_color_hover" name="border_color_hover" value="{{ $button->border_color_hover ?? config('nura.defaults.button_border_color_hover') }}">
                            <label>{{ __('Border color on mouse hover') }}</label>
                            <div class="mt-1 small"> {{ strtoupper($button->border_color_hover) ?? config('nura.defaults.button_border_color_hover') }}</div>
                            <script>

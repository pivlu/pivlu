        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Administrator accounts') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-5 col-md-6 order-md-1 order-first">
                <h4 class="card-title">
                    {{ __('Administrator accounts') }} ({{ $accounts->total() ?? 0 }})
                </h4>
            </div>
        ...
        <section>
            <form action="{{ route('admin.accounts.index') }}" method="get" class="row row-cols-lg-auto g-3 align-items-center">
                ...
                <div class="col-12">
                    ...
                    <a title="{{ __('Reset') }}" class="btn btn-light" href="{{ route('admin.accounts.index', ['role' => 'admin']) }}"><i class="bi bi-arrow-counterclockwise"></i></a>
                </div>

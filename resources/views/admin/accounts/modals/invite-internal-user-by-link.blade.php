        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('admin.accounts.send_invitation') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="inviteLinkInternalUser">{{ __('Invite internal user') }}</h5>
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="row bg-light mb-3 pt-3">
                        <div class="fw-bold mb-2">
                            ...
                            <br>
                            <a href="{{ route('admin.accounts.permissions') }}">{{ __('Manage internall accounts permissions') }}</a>.
                        </div>
                    </div>

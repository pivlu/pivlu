        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="add-account-note">{{ __('Create internal note') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label>{{ __('File attachment') }} ({{ __('optional') }})</label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">{{ __('Create internal note') }}</button>
                </div>

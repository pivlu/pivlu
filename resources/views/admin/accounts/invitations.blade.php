        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-7 col-md-6 order-md-2 order-last">
                <div class="float-end">
                    ...
                    @include('pivlu::admin.accounts.includes.modal-invite-internal-user-by-email')
                    @include('pivlu::admin.accounts.includes.modal-invite-internal-user-by-link')
                    @include('pivlu::admin.accounts.includes.modal-invite-internal-user-bulk')
                </div>
            </div>

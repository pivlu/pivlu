        ...
        <div class="card-body">
            ...
            <form method="post">
                        ...
                        <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                            <div class="form-group mb-2">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="link_decoration">
                                    ...
                                    <option @if (($templateConfig->link_decoration ?? null) == 'dotted') selected @endif value="dotted">{{ __('Dotted') }}</option>
                                    <option @if (($templateConfig->link_decoration ?? null) == 'dashed') selected @endif value="dashed">{{ __('Dashed') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                            <div class="form-group mb-2">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="link_hover_decoration">
                                    ...
                                    <option @if (($templateConfig->link_hover_decoration ?? null) == 'dotted') selected @endif value="dotted">{{ __('Dotted') }}</option>
                                    <option @if (($templateConfig->link_hover_decoration ?? null) == 'dashed') selected @endif value="dashed">{{ __('Dashed') }}</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-3 col-12">
                        <div class="form-group mb-2">
                            <input id="bg_color_hover" name="bg_color_hover" value="{{ $templateConfig->bg_color_hover ?? 'white' }}">
                            <label>{{ __('Background color (on mouse hover)') }}</label>
                            <div class="mt-1 small"> {{ $templateConfig->bg_color_hover ?? 'white' }}</div>
                            <script>

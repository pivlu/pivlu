            ...
            <div class="row">
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->bg_color) ?? config('pivlu.defaults.button_bg_color') }}</div>
                        <script>
                            $('#bg_color').spectrum({
                                type: "color",
                                showInput: true,
                ...
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->border_color) ?? config('pivlu.defaults.button_bg_color') }}</div>
                        <script>
                ...
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->font_color) ?? config('pivlu.defaults.button_font_color') }}</div>
                        <script>
                            $('#font_color').spectrum({
                                type: "color",
                                showInput: true,
            ...
            <div class="row">
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->bg_color_hover) ?? config('pivlu.defaults.button_bg_color_hover') }}</div>
                        <script>
                ...
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->border_color_hover) ?? config('pivlu.defaults.button_border_color_hover') }}</div>
                        <script>
                ...
                <div class="col-12 col-lg-3 col-md-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($data->font_color_hover) ?? config('pivlu.defaults.button_font_color_hover') }}</div>
                        <script>
                ...
                <div class="col-sm-4 col-md-4 col-lg-3 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="rounded">
                            <option @if ($data->rounded == '0') selected @endif value="0">{{ __('No radius') }}</option>
                            <option @if ($data->rounded == '0.2rem') selected @endif value="0.2rem">{{ __('Extra small') }}</option>
                            <option @if ($data->rounded == '0.35rem') selected @endif value="0.35rem">{{ __('Small') }}</option>
                            <option @if ($data->rounded == '0.45rem') selected @endif value="0.45rem">{{ __('Medium') }}</option>
                            <option @if ($data->rounded == '0.6rem') selected @endif value="0.6rem">{{ __('Large') }}</option>
                            <option @if ($data->rounded == '1rem') selected @endif value="1rem">{{ __('Extra large') }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-md-4 col-lg-3 col-12">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="font_weight">
                            <option @if ($data->font_weight == 'normal') selected @endif value="normal">{{ __('Normal') }}</option>
                            <option @if ($data->font_weight == 'bold') selected @endif value="bold">{{ __('Bold') }}</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div id="hidden_div_shadow" style="display: @if ($data->shadow ?? null) block @else none @endif" class="mt-1">
                    <div class="form-group mb-4">
                        ...
                        <select class="form-select" name="shadow_style">
                            <option @if ($data->shadow == 'shadow-sm') selected @endif value="shadow-sm">{{ __('Small') }}</option>
                            <option @if ($data->shadow == 'shadow') selected @endif value="shadow">{{ __('Normal') }}</option>
                            <option @if ($data->shadow == 'shadow-lg') selected @endif value="shadow-lg">{{ __('Large') }}</option>
                        </select>
                    </div>
                </div>
            </div>

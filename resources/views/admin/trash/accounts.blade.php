...
<div class="card">
    ...
    <div class="card-body">
        ...
        <section>
            <form action="{{ route('admin.trash.module', ['module' => 'accounts']) }}" method="get" class="row row-cols-lg-auto g-3 align-items-center">
                ...
                <div class="col-12">
                    ...
                    <a title="{{ __('Reset') }}" class="btn btn-light" href="{{ route('admin.trash.module', ['module' => 'accounts']) }}"><i class="bi bi-arrow-counterclockwise"></i></a>
                </div>
            </form>
        </section>
        ...
        @if ($items->total() == 0)
            {{ __('No item') }}
        @else
            <form method="POST" action="{{ route('admin.trash.multiple_action', ['module' => 'accounts']) }}">
                @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2">
                                            <a href="{{ route('admin.trash.single_action', ['module' => 'accounts', 'id' => $item->id, 'return_to' => 'trash', 'action' => 'delete']) }}"
                                                class="btn btn-danger btn-sm mb-2">{{ __('Permanently delete') }}</a>

                                            <a href="{{ route('admin.trash.single_action', ['module' => 'accounts', 'id' => $item->id, 'return_to' => 'trash', 'action' => 'restore']) }}"

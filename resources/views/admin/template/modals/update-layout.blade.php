                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="layout_top_{{ $layout->id }}" name="top" @if ($layout->top) checked @endif>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="layout_bottom_{{ $layout->id }}" name="bottom" @if ($layout->bottom) checked @endif>

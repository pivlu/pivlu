            ...
            <div class="row">
                ...
                <div class="form-group mt-3">
                    <div class="form-check form-switch">
                        ...
                        <div class="form-text"><a href="{{ route('admin.config', ['tab' => 'integration']) }}">{{ __('Manage reCAPTCHA keys') }}</a></div>
                    </div>
                </div>
                ...
                <div class="form-group mt-3">
                    <div class="form-check form-switch">
                        ...
                        <div class="form-text">{{ __('Notes: you can enable / disable  this setting for each user in Accounts page (edit user)') }}. <a
                                href="{{ route('admin.accounts.index') }}">{{ __('Manage accounts') }}</a></div>
                    </div>
                </div>

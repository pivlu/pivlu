                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-select" name="text_size">
                                @foreach ($font_sizes as $font_size)
                                    <option @if (($templateConfig->text_size ?? null) == $font_size->value) selected @endif @if (!($templateConfig->text_size ?? null) && $font_size->value == '1em') selected @endif value="{{ $font_size->value }}">{{ $font_size->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-3  col-xxl-2 col-12">
                        <div class="form-group mb-4">
                            ...
                            <select class="form-select col-md-6 col-lg-4 col-xl-3" name="text_align">
                                <option @if (($templateConfig->text_align ?? null) == 'left') selected @endif value="left">{{ __('Left') }}</option>
                                <option @if (($templateConfig->text_align ?? null) == 'center') selected @endif value="center">{{ __('Center') }}</option>
                                <option @if (($templateConfig->text_align ?? null) == 'right') selected @endif value="right">{{ __('Right') }}</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-select" name="font_family">
                                @foreach ($fonts as $font)
                                    <option @if (($templateConfig->font_family ?? null) == ($font->import."|".$font->value)) selected @endif value="{{ ($font->import."|".$font->value) }}" style="font-size: 1.6em; font-family: {{ $font->value }};">[{{ $font->name }}]
                        ...
                        <div class="col-sm-4 col-md-3  col-xxl-2 col-12">
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="text_weight">
                                    <option @if (($templateConfig->text_weight ?? null) == 'normal') selected @endif value="normal">{{ __('Normal') }}</option>
                                    <option @if (($templateConfig->text_weight ?? null) == 'bold') selected @endif value="bold">{{ __('Bold') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3  col-xxl-2 col-12">
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="link_weight">
                                    <option @if (($templateConfig->link_weight ?? null) == 'normal') selected @endif value="normal">{{ __('Normal') }}</option>
                                    <option @if (($templateConfig->link_weight ?? null) == 'bold') selected @endif value="bold">{{ __('Bold') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="link_underline_thickness">
                                    ...
                                    <option @if (($templateConfig->link_underline_thickness ?? null) == '6px') selected @endif value="6px">{{ __('Bolder') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                            <div class="form-group mb-4">
                                ...
                                <select class="form-select col-md-6 col-lg-4 col-xl-3" name="link_underline_offset">
                                    ...
                                    <option @if (($templateConfig->link_underline_offset ?? null) == '0.35em') selected @endif value="0.35em">{{ __('Medium offset') }}</option>
                                    <option @if (($templateConfig->link_underline_offset ?? null) == '0.6em') selected @endif value="0.6em">{{ __('Big offset') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-select" name="title_size">
                                @foreach ($font_sizes as $title_size)
                                    <option @if (($templateConfig->title_size ?? null) == $title_size->value) selected @endif @if (!($templateConfig->title_size ?? null) && $title_size->value == '1.2em') selected @endif value="{{ $title_size->value }}">{{ $title_size->name }}</option>
                                @endforeach
                            </select>
                        </div>                        
                    </div>
                    ...
                    <div class="col-sm-4 col-md-3  col-xxl-2 col-12">
                        <div class="form-group mb-4">
                            ...
                            <select class="form-select col-md-6 col-lg-4 col-xl-3" name="title_weight">
                                <option @if (($templateConfig->title_weight ?? null) == 'normal') selected @endif value="normal">{{ __('Normal') }}</option>
                                <option @if (($templateConfig->title_weight ?? null) == 'bold') selected @endif value="bold">{{ __('Bold') }}</option>
                            </select>
                        </div>
                    </div>
                </div>

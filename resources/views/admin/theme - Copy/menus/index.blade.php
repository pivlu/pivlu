        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.theme-menus.index') }}">{{ __('Theme menus') }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-5 col-md-6 order-md-1 order-first">
                    <h4 class="card-title">{{ __('Theme menus') }}</h4>
                </div>
                        ...
                        @foreach ($menus as $menu)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="fs-6 fw-bold">{{ $menu->label }} @if ($menu->is_default == 1)
                                            <span class="badge bg-light text-secondary"></i> {{ __('Default menu') }}</span>
                                        @endif
                                    </div>
                                ...
                                <td>
                                    <div class="d-grid gap-2">
                                        ...
                                        <a class="btn btn-gear btn-sm mb-2" href="{{ route('admin.theme-menus.show', ['id' => $menu->id]) }}">{{ __('Update menu') }}</a>

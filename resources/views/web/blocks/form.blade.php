...
<div class="container-xxl">
    <div class="block">
        ...
        @if ($block_settings['form_id'] ?? null)
            @php
                $form_fields = form($block_settings['form_id']);
            @endphp

            <form method="POST" action="{{ route('form.submit', ['id' => $block_settings['form_id'], 'lang' => $lang]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                @endif
                <button type="submit"
                    class="btn btn_{{ $block_settings['submit_btn_id'] ?? ' btn-primary' }} {{ button($block_settings['submit_btn_id'])->font_weight ?? null }} {{ button($block_settings['submit_btn_id'])->rounded ?? null }} {{ button($block_settings['submit_btn_id'])->shadow ?? null }} {{ button($block_settings['submit_btn_id'])->size ?? null }}">{{ $block_content['submit_btn_text'] ?? __('Submit') }}</button>

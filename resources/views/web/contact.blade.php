    ...
    <div class="content">
        ...
        <div class="container-xxl mt-5 mb-5">
            ...
            @if (($config->contact_custom_text ?? null) && ($config->contact_custom_text_location ?? null) == 'top')
                <div class="my-4">
                    {!! $config_lang->contact_custom_text ?? null !!}
                </div>
            @endif
            ...
            <div class="row">
                ...
                <div class="@if ((($config_lang->contact_custom_text ?? null) && ($config->contact_custom_text_location ?? null) == 'left') || ($config->contact_custom_text_location ?? null) == 'right') ) col-md-6 gx-5 @endif">
                ...
                @if (($config_lang->contact_custom_text ?? null) && ($config->contact_custom_text_location ?? null) == 'right')
                    <div class="col-md-6 gx-5">
                        {!! $config_lang->contact_custom_text ?? null !!}
                    </div>
                @endif
            ...
            @if (($config_lang->contact_custom_text ?? null) && ($config->contact_custom_text_location ?? null) == 'bottom')
                <div class="mb-4">
                    {!! $config_lang->contact_custom_text ?? null !!}
                </div>
            @endif

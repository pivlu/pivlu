<div class="container-xxl">
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 @if(!$layout->bg_color) ps-0 @endif">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 pe-0">
            @foreach (content_blocks($module, $content_id) as $block)
                @php
                    $block_extra = unserialize($block->block_extra);
                @endphp
                <div class="section" id="layout-{{ $block->id }}" @if ($block_extra['bg_color'] ?? null) style="background-color: {{ $block_extra['bg_color'] }}" @endif>

...
<body class="style_global">
    ...
    <div class="content">
        ...
        @if (($layout_sidebar ?? null) == 'left')
            @include('web.builder.layouts.layout-sidebar-left-posts-post')
        @elseif (($layout_sidebar ?? null) == 'right')
            @include('web.builder.layouts.layout-sidebar-right-posts-post')
        @else
            <div class="container-xxl mt-4 style_posts">
                @include('web.builder.includes.post-item')
            </div>
        @endif       

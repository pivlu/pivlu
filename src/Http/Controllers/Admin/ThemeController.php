...
use Pivlu\Cms\Models\Theme;
use Pivlu\Cms\Models\Plugin;
use Pivlu\Cms\Models\Language;
use Pivlu\Cms\Models\ThemeConfig;
use Pivlu\Cms\Models\ThemeConfigLang;
use Pivlu\Cms\Models\ThemeStyle;
use Pivlu\Cms\Models\ThemeButton;
use Pivlu\Cms\Models\ThemeFooter;
use Pivlu\Cms\Models\ThemeMenu;
use Pivlu\Cms\Models\BlockType;
...
class ThemeController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($theme_tab == 'style' || $theme_tab == 'nav') ThemeFunctions::generate_theme_css($theme->slug);
    ...
    public function update_logo(Request $request)
    {
        ...
        return redirect(route('admin.themes.show', ['slug' => $slug, 'theme_tab' => 'general']))->with('success', 'updated');
    }

...
use Pivlu\Cms\Functions\PluginFunctions;
...
class PluginController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pivlu::admin.index', [
            'view_file' => 'admin.config.plugins',
            'active_menu' => 'config',
    ...
    public function update(Request $request)
    {
        ...
        foreach ($modules as $module => $status) {
            ...
            if ($module_array[0] == 'module') {
                ...
                $module = Plugin::where('id', $module_id)->first();
        ...
        return redirect(route('admin.plugins'))->with('success', 'updated');
    }
}

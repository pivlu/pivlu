...
class PostBlock extends Model
{
    ...
    public static function update_block($id, $type, $request)
    {
        ...
        if ($type == 'poll') {
            ...
            PostBlock::where('id', $id)->update(['extra' => serialize($block_extra)]);
        }
        ...
        if ($type == 'accordion') {
            ...
            PostBlock::where('id', $id)->update(['extra' => serialize($block_extra), 'header' => $header_content, 'content' => $content ?? null]);
        }
        ...
        if ($type == 'alert') {
            ...
            PostBlock::where('id', $id)->update(['extra' => serialize($block_extra), 'content' => $content]);
        }
        ...
        if ($type == 'video') {
            ...
            PostBlock::where('id', $id)->update(['extra' => serialize($block_extra), 'header' => $header_content, 'content' => $content]);
        }
        ...
        if ($type == 'map') {
            ...
            PostBlock::where('id', $id)->update(['extra' => serialize($block_extra), 'header' => $header_content]);
        }
        ...
        if ($type == 'links') {
           ...
           PostBlock::updateOrInsert(['id' => $id], ['content' => $content]);

            // header data
            $header_array = array();
            $header_array = array('add_header' => $inputs['add_header'] ?? null, 'title' =>  $inputs["header_title"] ?? null, 'content' =>  $inputs["header_content"] ?? null);
            $header_content = serialize($header_array);
            PostBlock::where(['id' => $id])->update(['header' => $header_content]);
        }
